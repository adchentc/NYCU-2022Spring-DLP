...
from utils import init_weights, kl_criterion_lp, plot_pred, plot_rec, finn_eval_seq, pred_lp, plot_curve
    ...
    for epoch in range(start_epoch, start_epoch + niter):
        ...
        if epoch % 1 == 0:
            ...
            for _ in range(len(validate_data) // args.batch_size):
                ...
                pred_seq = pred_lp(validate_seq[:12], validate_cond[:12], modules, args)
