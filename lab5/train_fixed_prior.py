...
def parse_args():
    ...
    parser.add_argument('--tfr_decay_step', type=float, default=0.01333, help='The decay step size of teacher forcing ratio (0 ~ 1)')
...
if __name__ == '__main__':
    ...
    if args.model_dir != '':
        ...
        saved_model = torch.load('%s/model_56.pth' % args.model_dir)
        ...
        print(f'Using pre-trained: {args.model_dir}/model_56.pth')
